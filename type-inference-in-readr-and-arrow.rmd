...
What if you want to use Arrow types instead of R types though? In this case, you need to use a schema.  I won’t go into detail here, but in short, schemas are lists of fields, all of which contain a field name and a data type.  You can specify a schema like this:
